...
Waves 2 to 4 (copy, clean paste and export; folding, outline, find, version history and the other surfaces; the AI actions) and the ink ruling follow, each its own push.
