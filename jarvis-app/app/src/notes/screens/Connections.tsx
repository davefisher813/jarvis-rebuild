  ...
  return (
    <div className="screen">
      ...
      <div className="pad-x">
        <div className="card">
          <div className="row">
            <div className="proj-icon cat-bg-health"><Tag className="ic" /></div>
            <div className="conn-name">Category</div>
            <span className="conn-meta">Health</span>
            <div className="chev"></div>
          </div>
          <div className="row">
            <div className="proj-icon cat-bg-tucci"><CalendarDays className="ic" /></div>
            <div className="conn-name">Event</div>
            <span className="conn-meta">Long Run Sunday</span>
            <div className="chev"></div>
          </div>
          <div className="row">
            <div className="proj-icon cat-bg-elite"><ListChecks className="ic" /></div>
      ...
      <div className="pad-x">
        <div className="card">
          <div className="row" onClick={onCreateTasks}>
            <div className="proj-icon cat-bg-money"><ListTodo className="ic" /></div>
