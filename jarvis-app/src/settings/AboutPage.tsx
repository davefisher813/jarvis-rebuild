...
export default function AboutPage({ onBack, onTerms, onPrivacy, onSupport }: { onBack: () => void; onTerms?: () => void; onPrivacy?: () => void; onSupport?: () => void }) {
  return (
    <div className="screen">
      ...
      <div className="pad-x"><div className="card about-hero">
        ...
        <div className="account-sub">Version 1.0</div>
      </div></div>
