...
describe("EventSheet", () => {
  ...
  it("blocks save until title present, then saves the draft", () => {
    ...
    fireEvent.click(screen.getByText("Save"));
    expect(onSave).toHaveBeenCalledWith({ title: "Standup", date: "2026-05-24", start: "09:00", end: "10:00", category: "c1", location: "", recurrence: "none", taskIds: [] });
  });
  ...
  it("category switch wears its slot color and saves its id", () => {
    ...
    fireEvent.click(screen.getByText("Save"));
    expect(onSave).toHaveBeenCalledWith({ title: "Lunch", date: "2026-05-24", start: "09:00", end: "10:00", category: "c2", location: "", recurrence: "none", taskIds: [] });
  });
