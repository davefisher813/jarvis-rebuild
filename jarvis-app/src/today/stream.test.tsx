...
// TODAY-F-18 (2026-09-05): there were three forms and these four cases were
// the only thing still asking for the headliner. The stream stopped promoting
// anything to one on 2026-08-22 (see the cases above, which pin that), so the
// branch and its CSS went and its cases go with them.
