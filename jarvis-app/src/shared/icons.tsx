...
// SHARED-F-20 (2026-09-05): ChevronDown and ChevronUp went. They were
// pre-registered halves of a pair nothing ever imported; the two that are
// used are Left and Right.
...
// The options glyph (2026-09-17 unified headers): the page's Area, Sort,
// Group and secondary tools, behind one control in the bar.
export const SlidersHorizontal = /* @__PURE__ */ outline(SlidersHorizontalOutline);
...
// The writing bar (2026-09-14): quote, code, divider, indent, outdent, clear.
export const Quote = /* @__PURE__ */ outline(QuoteOutline);
export const Code = /* @__PURE__ */ outline(CodeOutline);
export const Minus = /* @__PURE__ */ outline(MinusOutline);
export const IndentIncrease = /* @__PURE__ */ outline(IndentIncreaseOutline);
export const IndentDecrease = /* @__PURE__ */ outline(IndentDecreaseOutline);
export const Eraser = /* @__PURE__ */ outline(EraserOutline);
// Copy and Export on the note header (the writing system, wave 2).
export const Copy = /* @__PURE__ */ outline(CopyOutline);
export const Share = /* @__PURE__ */ outline(ShareOutline);
