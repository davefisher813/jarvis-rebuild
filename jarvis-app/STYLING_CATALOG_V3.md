...
10. THE 4/5 BLEND (Dave's pick, 2026-08-19): document headings wear an editorial number in brand red (CSS counter, decimal-leading-zero, renumbers itself) with a dotted red leader running to the margin. Doc titles are 30px at -0.02em; body is 17px at 1.65. Tables are steel: surfaced card, quiet header band, red-washed Total row with the accent total. This is the writing canvas's one styling; a section head without its number and leader is a violation.
