...
10. BLACK STEEL CANVAS (Dave's pick, 2026-08-19, revised "closer to 5"): document headings are red mini-caps (12px, bold, 0.14em tracking, uppercase via CSS) with a dotted red leader running to the margin. No numbers. Doc titles stay editorial: 30px at -0.02em; body 17px at 1.65. Tables are steel: surfaced card, quiet header band, red-washed Total row with the accent total. This is the writing canvas's one styling; a section head without its red caps and leader is a violation.
